      ...
      <div className="container max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-300 max-w-3xl mx-auto">
            A private intellectual community uniting those who have become part of our mission through participation in the BACON NFT project.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <section>
            <p className="text-lg leading-relaxed">
              The Friends of the Institute Club is a private intellectual community uniting those who have become part of our mission through participation in the BACON NFT project. Membership in the Club is open to those who hold one or more of the Institute's digital assets.
            </p>
          </section>
              ...
              <table className="w-full border-collapse border border-gray-700">
                <thead>
                  <tr className="bg-[#282828]">
                    <th className="border border-gray-700 p-4 text-left">Category</th>
                    <th className="border border-gray-700 p-4 text-left">Eligibility</th>
                    <th className="border border-gray-700 p-4 text-left">Access & Role</th>
                  </tr>
                </thead>
                <tbody>
          ...
          {/* Principle */}
          <section className="bg-[#282828] p-8 rounded-lg">
            <h2 className="text-2xl font-light mb-4">Principle</h2>
            <p className="text-lg leading-relaxed">
              We do not create a "white list." Instead, we maintain a list of friends—individuals who share our belief that art is not a commodity, but a testament to the human spirit, and that its preservation, interpretation, and transmission demand collective effort, conviction, and inner discipline.
            </p>
          </section>
        </div>
      </div>
